 ...
 */
void
vmfs_invalid_dir_cache(struct inode * dir)
{
 ...
 */
void
vmfs_invalidate_dircache_entries(struct dentry *parent)
{
 ...
 */
struct dentry *
vmfs_dget_fpos(struct dentry *dentry, struct dentry *parent, unsigned long fpos)
{
